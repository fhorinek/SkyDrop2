...
void (* gui_init_array[])() =
	...
	gui_accelerometer_calib_init, gui_filemanager_init, gui_flightdetail_init,
	gui_gyro_calib_init, gui_home_init,
	...
	gui_waypoint_list_init, gui_waypoint_editor_init, gui_task_settings_init, gui_factory_test_init};
...
void (* gui_stop_array[])() =
	...
	gui_accelerometer_calib_stop, gui_filemanager_stop, gui_flightdetail_stop,
	gui_gyro_calib_stop, gui_home_stop,
	...
	gui_waypoint_list_stop, gui_waypoint_editor_stop, gui_task_settings_stop, gui_factory_test_stop};
...
void (* gui_loop_array[])() =
	...
	gui_accelerometer_calib_loop, gui_filemanager_loop, gui_flightdetail_loop,
	gui_gyro_calib_loop, gui_home_loop,
	...
	gui_waypoint_list_loop, gui_waypoint_editor_loop, gui_task_settings_loop,  gui_factory_test_loop};
...
void (* gui_irqh_array[])(uint8_t type, uint8_t * buff) =
	...
	gui_accelerometer_calib_irqh, gui_filemanager_irqh, gui_flightdetail_irqh,
	gui_gyro_calib_irqh, gui_home_irqh,
	...
	gui_waypoint_list_irqh, gui_waypoint_editor_irqh, gui_task_settings_irqh, gui_factory_test_irqh};
...
void gui_loop()
{
	...
	if (actual_task == TASK_ACTIVE)
	{
		...
		if (gui_task != GUI_PAGES
				...
				&& !(gui_task == GUI_DIALOG && gui_dialog_style != GUI_STYLE_STATS)
				&& gui_task != GUI_SPLASH
		...
		if (gui_task == GUI_PAGES)
		{
			//Power off if not in flight, hike, auto power off is enabled and bluetooth device is not connected
