...
void acc_save_calibration(vector_float_t sens_vf, vector_float_t bias_vf)
{
	...
	ee_update_block(&bias, &config_ro.calibration.acc_bias, sizeof(config_ro.calibration.acc_bias));
	ee_update_block(&sens, &config_ro.calibration.acc_sensitivity, sizeof(config_ro.calibration.acc_sensitivity));
...
void acc_load_calibration(volatile vector_float_t * sens_vf, volatile vector_float_t * bias_vf)
{
	...
	ee_read_block(&bias, &config_ro.calibration.acc_bias, sizeof(config_ro.calibration.acc_bias));
	ee_read_block(&sens, &config_ro.calibration.acc_sensitivity, sizeof(config_ro.calibration.acc_sensitivity));
