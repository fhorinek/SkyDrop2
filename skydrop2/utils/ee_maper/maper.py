...
path = "../../skydrop2_configurator/app/fw/%08d/" % number
...
#disassembly
shutil.copyfile("skydrop2.lss", os.path.join(path, "skydrop2.lss"))

#copy last update file
shutil.copyfile("DROP2.EE", os.path.join("../../skydrop2_configurator/app/", "DROP2.EE"))
print "ok"
